    ...
    return (
        <div className="font-bold z-50 relative">
            ...
            <h1 className="text-9xl text-white w-4/5 relative z-50">
                ...
                <span className="relative leading-none z-50 w-auto my-4 inline-block">
                    <u className="relative bg-dark_blue h-auto inline-block" onMouseEnter={() => setHover(true)} 
                        onMouseLeave={() => setHover(false)}>
                            SEI
                    </u>
                    <span className="bg-dark_blue h-auto inline-block"> &nbsp;that</span>
                    <div className={styles.cardWrapper}>
                        <Fade top when={hovered}>
