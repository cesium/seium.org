...
export default function Title() {
    return (
        <div className="font-bold z-50 relative">
            ...
            <h1 className="relative font-iextrabold text-white text-6xl w-11/12 md:text-8xl md:w-full xl:text-9xl 2xl:w-4/5 relative z-50">
                <span className="relative z-50">The software engineering week is back, let's just&nbsp;</span>
