...
export default function Title() {
    ...
    return (
        <div className="font-bold z-50 relative">
            <h5 className="font-inter_extrabold text-2xl text-aqua m-1">
                15-20 February 2022
            </h5>
            <h1 className="font-inter_extrabold font-bold text-white text-6xl w-11/12 md:text-8xl md:w-full xl:text-9xl 2xl:w-4/5 relative z-0">
                    ...
                    <div className={styles.cardWrapper}>
                        <Fade top when={hovered} distance="10px">
                            <Card className="z-0" img="/images/mascot-footer.svg" alt="MascotFooter" inverted={true}>
                                <h5 className={`font-inter_light ${styles.cardText}`}>Did you see what I did there?</h5>
                            </Card>
                        </Fade> 
                    </div>
                </span>
