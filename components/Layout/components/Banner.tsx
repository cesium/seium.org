...
function PlainBanner({ spotlight }: { spotlight: ISpotlight }) {
  ...
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-orange-200 px-6 py-3 sm:px-3.5 sm:before:flex-1">
      <div
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-base leading-6 text-gray-900">
          ...
          Visit them now to get a token bonus
          <svg
            viewBox="0 0 2 2"
            className="mx-2 inline h-0.5 w-0.5 fill-current"
            aria-hidden="true"
        ...
        <p className="flex-none px-3.5 py-1 text-lg font-semibold text-gray-900 shadow-sm">
          {remaining}
        </p>
      </div>
