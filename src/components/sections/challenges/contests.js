...
function Contests() {
  ...
  let challenge1 = (
    <Challenge
      title="CV Contest"
      parag="Our sponsors want your CV. You want them to have it. And why not try to win a PS5 while you’re at it? Submit your CV to cv@seium.org and be automatically entered into a contest to win a PS5! It goes without saying that by sending us your CV, you give us consent to share it with our Silver, Gold and Exclusive sponsors."
      buttonText={
  ...
  let challenge2 = (
    <Challenge
      title="CTF"
      parag="Self explanatory, right? Test you security and general skills and find those pesky flags in our CTF! Be on of the first three to submit all the flags and win an awesome Raspberry Pi 4!"
      buttonText=""
      prizes={[
  ...
  let challenge4 = (
    <Challenge
      ...
      parag="Take a cool pic related to say, share it in your stories and tag @sei.uminho, the take a screenshot and send it to us! You’ll be entered in a draw to win a fantastic Polaroid camera! (Bonus points if your profile is public so we can share your story. Ok, the aren’t really bonus points, but we’d be happy :D )
  ...
  let challenge5 = (
    <Challenge
      ...
      parag="Big brain? Then come and show it off! If you can manage to win, we have a very nice, wood chess set to give you!"
      buttonText={
  ...
  let challenge6 = (
    <Challenge
      ...
      parag="Make a team and come and show off your talent in you CS:GO tournament! We have an 8 team limit, so make sure you move fast!"
      buttonText={
