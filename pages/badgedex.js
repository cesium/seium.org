...
export default function Badgedex() {
    ...
    return (
        <Dashboard href="badgedex" title="BadgeDex" description="Explore all existing badges">
            <div className="pt-10 xl:flex xl:flex-auto">
                <div className="flex flex-auto space-x-5">
                    <p className="mb-10 xl:mb-0 font-bold text-2xl">
                        Filter by
                    </p>
                    <Filter />
                </div >
                <div className="w-auto lg:w-1/2 xl:w-auto font-bold text-2xl grid grid-cols-3 xl:gap-x-8">
                    ...
                    <BadgeButton text="ALL" val={val} setValue={setValue} selected={val} />
                    <BadgeButton text="MINE" val={val} setValue={setValue} selected={!val} />
                </div>
            </div>
