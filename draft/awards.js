    ...
    <Dashboard href="awards">
        <div>
            <div className="md:mt-16 mt-8">
                ...
                <p className="text-md sm:text-lg text-iregular">Win awards with your collected tokens</p>
            </div>
            
            <div className="border-black border-b-2 mt-14">
                <span className="font-ibold text-xl sm:text-2xl">Achievements</span>
                <span className="font-iregular ml-24 text-md sm:text-lg">💰170 tokens</span>
                <span className="font-iregular ml-24 text-md sm:text-lg">🏅68 badges</span>
            </div>
